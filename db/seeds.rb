...
user_1 = User.create(name: 'Francisco', last_name: 'Borie', email: 'fjborie@miuandes.cl', phone: 987654321, password: 'password.123', address: 'San Carlos de Apoquindo 2200')
